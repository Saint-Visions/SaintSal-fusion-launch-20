    ...
    <div className="min-h-screen bg-charcoal-900 text-white relative overflow-hidden">
      ...
      <nav className="relative z-50 flex items-center justify-between p-4 md:p-6 lg:px-12 border-b border-white/10">
        <div className="flex items-center space-x-3 md:space-x-4">
          <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-purple-400 to-purple-600 rounded-lg flex items-center justify-center saintvision-glow">
      ...
      <div className="relative z-40 px-4 md:px-6 py-6 md:py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            className={`grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-6 md:mb-8 transform transition-all duration-1000 delay-300 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
          ...
          <div className="grid lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="lg:col-span-2">
              <div
                className={`space-y-6 md:space-y-8 transform transition-all duration-1000 delay-500 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
              >
            ...
            <div className="lg:col-span-1">
              <div
                className={`space-y-6 md:space-y-8 transform transition-all duration-1000 delay-700 ${isLoaded ? "translate-x-0 opacity-100" : "translate-x-10 opacity-0"}`}
              >
                {/* Recent Referrals */}
                <div className="glass-morphism p-4 md:p-6 rounded-xl">
                    ...
                    {recentReferrals.map((referral, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-2">
                            <Badge
                              className={`${getStatusColor(referral.status)} text-xs`}
                            >
                              {referral.status}
                            </Badge>
