...
export default function Upgrade() {
  ...
  const plans = [
    ...
    },
    {
      ...
      subtitle: "Your Complete GOTTA GUY™",
      ...
      limits: ["No limits on core features"],
      stripePriceId: process.env.VITE_STRIPE_UNLIMITED_PRICE_ID,
      icon: Crown,
    ...
    },
    {
      ...
      limits: ["Enterprise-grade unlimited access"],
      stripePriceId: process.env.VITE_STRIPE_WHITE_LABEL_PRICE_ID,
      icon: Building,
    ...
    {
      id: "custom",
      name: "White-Label Empire",
      subtitle: "Complete Platform Ownership",
      ...
      limits: ["Unlimited everything + custom development"],
    ...
    <div className="min-h-screen bg-charcoal-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-40 px-6 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Pricing Plans */}
          <div
            className={`grid lg:grid-cols-2 xl:grid-cols-4 gap-8 mb-16 transform transition-all duration-1000 delay-400 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
            {plans.map((plan) => {
          ...
          {/* Features Comparison */}
          <div
            className={`mb-16 transform transition-all duration-1000 delay-600 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
