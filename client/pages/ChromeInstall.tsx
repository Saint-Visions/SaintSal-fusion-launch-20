    ...
    <div className="min-h-screen bg-charcoal-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-40 px-6 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          {extensionDetected ? (
            <div
              className={`mb-16 transform transition-all duration-1000 delay-200 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            >
            ...
            /* Installation Steps */
            <div
              className={`mb-16 transform transition-all duration-1000 delay-300 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            >
          ...
          {/* Features Showcase */}
          <div
            className={`mb-16 transform transition-all duration-1000 delay-500 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
            <h2 className="text-3xl font-bold text-center mb-12">
              <span className="saintvision-gradient-text">
                Extension Features
