    ...
    <div className="min-h-screen bg-charcoal-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-40 px-6 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Main Content Grid */}
          <div
            className={`grid lg:grid-cols-4 gap-8 mb-16 transform transition-all duration-1000 delay-500 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
            {/* Sidebar - Categories */}
