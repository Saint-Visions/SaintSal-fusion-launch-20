        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-white/80 mb-6 max-w-3xl">
              Customize your SaintSal™ experience, manage your AI assistant,
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div
                className={`glass-morphism rounded-2xl p-6 transform transition-all duration-1000 delay-300 ${isLoaded ? "translate-x-0 opacity-100" : "-translate-x-10 opacity-0"}`}
              >
