    ...
    <div className="min-h-screen bg-charcoal-900 text-white relative overflow-hidden">
      ...
      <nav className="relative z-50 flex items-center justify-between p-4 md:p-6 lg:px-12 border-b border-white/10">
        <div className="flex items-center space-x-3 md:space-x-4">
          <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-red-400 to-red-600 rounded-lg flex items-center justify-center saintvision-glow">
        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          ...
          >
            <RefreshCw
              className={`w-4 h-4 ${isRefreshing ? "animate-spin" : ""} ${window.innerWidth < 768 ? "" : "mr-2"}`}
            />
      ...
      <div className="relative z-40 px-4 md:px-6 py-6 md:py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            className={`mb-6 md:mb-8 transform transition-all duration-1000 delay-500 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
