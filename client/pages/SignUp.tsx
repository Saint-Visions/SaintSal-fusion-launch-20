  ...
  return (
    <div className="min-h-screen bg-charcoal-900 text-white relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(16, 22, 28, 0.65) 0%, rgba(16, 22, 28, 0.55) 100%), 
      ...
      <div className="relative z-40 px-6 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="mb-8">
              <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-gold-400 to-gold-600 rounded-2xl flex items-center justify-center saintvision-glow-strong">
                <Crown className="w-10 h-10 text-charcoal-900" />
              </div>
            </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-start space-x-4">
                          <div
                            className={`w-16 h-16 bg-gradient-to-br ${plan.gradient} rounded-xl flex items-center justify-center ${isSelected ? "saintvision-glow" : ""}`}
                          >
          ...
          <div
            className={`text-center transform transition-all duration-1000 delay-700 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
